...
def main():
    target = np.array( io.imread("input2_ori.bmp"), dtype = float)/255
    image = np.array( io.imread("input2.bmp"), dtype=float)      # RGB
    gaussian = make_gfilter( 3.5, 31 )
    ...
    '''
    imager = wiener( egaufft, imager, 0.04 )
    imageg = wiener( egaufft, imageg, 0.04 )
    imageb = wiener( egaufft, imageb, 0.04 )   
